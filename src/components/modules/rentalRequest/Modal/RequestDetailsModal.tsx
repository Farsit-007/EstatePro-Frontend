...
const RequestDetailsModal = ({ id }: { id: string }) => {
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2">
                ...
                {data?.houseId?.landlordId?._id ? (
                  <>
                    {" "}
                    <DetailItem
                      label="Landlord Name"
                      value={data?.houseId?.landlordId?.name}
                    />
                    <DetailItem
                      label="Landlord Email"
                      value={data?.houseId?.landlordId?.email}
                    />
                  </>
                ) : (
                  ""
            ...
            {data?.status === "approved" && (
              <>
                ...
                {(data?.paymentStatus === "Paid" ||
                  ...
                  <div
                    className={`mt-4 p-4 rounded-lg flex justify-between border-l-4 ${
                      data?.paymentStatus === "Paid"
                  ...
                  >
                    ...
                    >
                      {data?.paymentStatus || "No payment status available"}
                    </p>
                  </div>
                )}
              </>
